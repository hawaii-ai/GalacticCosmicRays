...
file_version='2023' # 2023 is what we are using for the Neural Surrogate HMC paper # 2024 is the yearly data, 2023 is the old data, test_data is NN test dataset
...
# hmc_version_number='split_uncertainty_w09_k2_v34_trial5_interpolated_'$file_version # Remember to update!
...
for w in 0.9 0.95 0.99; do
  for k in 1.5 2 4; do
    ...
    # FIXED: Added the $ to properly reference the loop variables
    export W=$w
    export K=$k
